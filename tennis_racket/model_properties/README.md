...
Standard adult tennis rackets measure 68.6-73.6 [cm] in length and about 25-28 [cm] in width across the head. The weight is 0.250 - 0.350 [kg]. The composite material used has a density of 1500 - 1800 [kg] per [m3].
...
Note that in the CAD are also considered strings with a density higher than the expected ones since the same density is imposed everywhere. However, the strings has small volume, therefore we assume their mass negligible.
